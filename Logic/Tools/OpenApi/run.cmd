...
java -jar openapi-generator-cli.jar generate -i ./APIConfiguration.yaml -g csharp -o ../../FireAlarmConfigTool.Logic.Http.Client --additional-properties=apiName=HttpClient,packageName=FireAlarmConfigTool.Logic.Http.Client,packageTitle=FireAlarmConfigTool.Http.Client
pause