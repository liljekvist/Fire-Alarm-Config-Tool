# FireAlarmConfigTool.Logic.Http.Client - the C# library for the Fire Alarm Config Tool API
...
```
nuget pack -Build -OutputDirectory out FireAlarmConfigTool.Logic.Http.Client.csproj
```
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**TestGet**](docs/DefaultApi.md#testget) | **GET** /test | Test endpoint
